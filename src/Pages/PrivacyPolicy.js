...
function PrivacyPolicy() {
  ...
  return (
    <div className="pp">
      <PageInfo title={"Home / Privacy Policy"} />
      <div className="pp-container py-2r">
        <h2 className="font-poppins">Privacy Policy</h2>
        ...
        <h3 className="pp-h3">Interpretation and Definitions</h3>
        <h4 className="pp-h4">Interpretation</h4>
        <div>
        ...
        <br />
        <h4 className="pp-h4">Definitions</h4>
        <div>For the purposes of this Privacy Policy:</div>
        <br />
        <div className="pp-left-mar">
          ...
          "Our" in this Agreement) refers to Trident Electrical Group, 20-22
          ...
          <br />
          <b>Website</b> refers to tridentelectricalgroup.com, accessible from
          tridentelectricalgroup.com
          <br />
          You means the individual accessing or using the Service, or the
          company, or other legal entity on behalf of which such individual is
          accessing or using the Service, as applicable.
        </div>
        <h3 className="pp-h3">Collecting and Using Your Personal Data</h3>
        <h4 className="pp-h4">Types of Data Collected</h4>
        <br />
        ...
        <div>
          ...
          <div className="pp-left-mar">
            ...
            <br />• <b>Web Beacons.</b> Certain sections of our Service and our
        ...
        <h4 className="pp-h4">Use of Your Personal Data</h4>
        <div>
          <div className="pp-left-mar">
          ...
          <div className="pp-left-mar">
            ...
            <br />• <b>For business transfers:</b> We may share or transfer Your
            ...
            <br />• <b>With Affiliates:</b> We may share Your information with
            Our affiliates, in which case we will require those affiliates to
            honor this Privacy Policy. Affiliates include Our parent company and
            any other subsidiaries, joint venture partners or other companies
            that We control or that are under common control with Us.
            <br />• <b>With business partners:</b> We may share Your information
            with Our business partners to offer You certain products, services
            or promotions.
            <br />• <b>With other users:</b> when You share personal information
            or otherwise interact in the public areas with other users, such
            information may be viewed by all users and may be publicly
            distributed outside.
            <br />• <b>With Your consent:</b> We may disclose Your personal
            information for any other purpose with Your consent.
            <br />
          </div>
        </div>
        <br />
        <h4 className="pp-h4">Retention of Your Personal Data</h4>
        <div>
        ...
        <h4 className="pp-h4">Transfer of Your Personal Data</h4>
        <div>
        ...
        <h4 className="pp-h4">Delete Your Personal Data</h4>
        <div>
        ...
        <h4 className="pp-h4">Disclosure of Your Personal Data</h4>
        <br />
        <h4 className="pp-h4">Business Transactions</h4>
        <div>
        ...
        <h4 className="pp-h4">Law enforcement</h4>
        <div>
        ...
        <br />
        <h4 className="pp-h4">Other legal requirements</h4>
        <div>
        ...
        <h4 className="pp-h4">Security of Your Personal Data</h4>
        <div>
        ...
        <h4 className="pp-h4">Children's Privacy</h4>
        <div>
        ...
        <h4 className="pp-h4">Links to Other Websites</h4>
        <div>
        ...
        <h4 className="pp-h4">Changes to this Privacy Policy</h4>
        <div>
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.<br/><br/>
          ...
          <h4 className="pp-h4">Contact Us:</h4>
          <div>
          If you have any questions about this Privacy Policy, You can contact us:
          <div className="pp-left-mar">•	By email: Info@tridentelectricalgroup.com</div>
          </div>
      </div>
    </div>
  );
